...
public class MyBatisPlusGenerator {
    ...
    public static void main(String[] args) {
        ...
        pc.setParent(null);
        pc.setEntity("com.dhxh.guns.common.persistence.model");
        pc.setMapper("com.dhxh.guns.common.persistence.dao");
        pc.setXml("com.dhxh.guns.common.persistence.dao.mapping");
